...
class NPC:
    ...
    def display_npc(self, surface, boolean, rotate):
        ...
        if boolean:
            ...
            self.flipped_sprite = pygame.transform.rotate(self.player_sprite, rotate)
            self.rect = self.flipped_sprite.get_rect(center = (self.x, self.y))
            self.talk_rect = self.flipped_sprite.get_rect(center = (self.x, self.y)).inflate(60,40)
        ...
        surface.blit(self.flipped_sprite, self.rect)
    ...
    def dialogue_lines(self, surface, boolean, direction, textbox, list_of_strings, dialogue_index, numx, numy, expandx, expandy):
        ...
        setattr(self.rect_str, self.direction, (self.x + expandx, self.y + expandy))
        ...
        setattr(self.textbox_surface, self.direction, (self.x + numx, self.y - numy))
